# Welcome!
Please complete Part 1 and Part 2 of the take home challenge. As you create any files or make changes, please do your best to explain them in comments or separate documents so that people can follow your method. 
## Part 1
...
```
(For Task 3 & 4, you can use utils in HTTPrequests.py for testing, but feel free to write your own tests)
